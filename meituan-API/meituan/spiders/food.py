...
class FoodSpider(scrapy.Spider):
    name = 'food'
    allowed_domains = ['sh.meituan.com']
    start_urls = ['https://sh.meituan.com/meishi/']
    ...
    def parse_food(self, response):
        ...
        # loader.add_xpath('restaurant_name', '//*[@id="app"]//li/div[2]/a/h4/text()',
        #                  MapCompose(str.strip))
        # loader.add_xpath('location', '//*[@id="app"]//li/div[2]/a/p/text()',
        #                  MapCompose(str.strip))
        # # '//*[@id="app"]//li[page]//*[@class="desc"]/span/text()'
        # loader.add_xpath('price', '//*[@id="app"]//li/div[2]/a/p/span/text()',
        #                  MapCompose(int), re='[0-9]+')
        # loader.add_xpath('star', '//*[@id="app"]//li/div[2]/a/div/p/text()',
        #                  MapCompose(float), re='[.0-9]+')
        # loader.add_xpath('img_url', '//*[@id="app"]//li/div[1]//*[@class="imgbox"]/img/@src',
        #                  MapCompose(str.strip))
        # loader.add_xpath('comment_num', '//*[@id="app"]//li/div[2]/a/div/p/span/text()',
        #                  MapCompose(int), re='[0-9]+')
        #
